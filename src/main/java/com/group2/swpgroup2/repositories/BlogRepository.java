...
public interface BlogRepository extends JpaRepository<Blog,Integer>{
    ...
    //get top 3 blog have highest rating and newest
    @Query(value = "SELECT TOP(3) * FROM Blog WHERE status = 'public' AND category = 'Demo' ORDER BY rating DESC, date DESC", nativeQuery = true)
    public List<Blog> findTop3BlogByRatingAndDate();
